...
/// <summary>
///   Represents the unix specific context unit for the application's config related storage.
/// </summary>
public sealed class UnixConfigStorageContextUnit(IContextProviderUnit? provider) : BaseConfigStorageContextUnit(provider)
{
   #region Fields
   ...
   protected override void OnAttach()
   {
      ...
      {
         string directory = Path.Combine(baseDirectory, appName);
